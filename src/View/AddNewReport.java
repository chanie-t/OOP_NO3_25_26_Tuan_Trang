...
public class AddNewReport implements Option {
    ...
    public void operation(Scanner s, Database database, User u) {
        ...
        s.nextLine();
        r.setDateTime(s.nextLine());

        System.out.println("Enter diagnosis: ");// Chuẩn đoán bị bệnh gì
        r.setDiagnosis(s.nextLine());
        System.out.println("Enter treatment: "); // Cách điều trị
        r.setTreatment(s.nextLine());
        r.setPaid(false);
